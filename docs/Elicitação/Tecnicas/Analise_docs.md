...
|---------------|------------------------------------------------------------------------------------------------|-----------|-----|---|-------|----|
| ADD01         |  O aplicativo deve permitir o acesso do usuário através de uma autenticação com o gov. | RF       | Sim | 1.1    | Gov.br/Jornada do Estudante  | [link](https://www.gov.br/mec/pt-br/jornadadoestudante#:~:text=Na%20Figura%201,com%20o%20estudante) |
| ADD02         |  O aplicativo deve possibilitar o envio de dados de forma simplificada.                                       | RF       | Sim | 1.0    | Gov.br/Jornada do Estudante | [link](https://www.gov.br/mec/pt-br/jornadadoestudante#:~:text=Software%20para%20inser%C3%A7%C3%A3o%20e%20envio%20de%20dados%20de%20forma%20simplificada%3B) |
...
| ADD011 | O aplicativo deve possibilitar a visualização de documentos digitais estudantis autenticados, como, diplomas e histórico escolar. | RF | Não | 1.0 | Gov.br/Jornada do Estudante | [link](https://www.gov.br/mec/pt-br/jornadadoestudante#:~:text=O%20aplicativo%20permite,o%20estudante%20brasileiro.) |
