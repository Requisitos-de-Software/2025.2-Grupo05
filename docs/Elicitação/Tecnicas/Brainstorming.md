...
| ------------- | --------------------------------------------------------------------------------------------------------------------- | --------- | ------------ | ------ | ---------------------------------------------- |
| B01           | O aplicativo deve permitir a visualização do professor das diciplinas                                                 | RF        | Não          | 1.0    | [Brainstorm de elicitação de requisitos](https://youtu.be/OuCuQnkgDT4)         |
| B02           | O aplicativo deve permitir a visualização do horário e sala da disciplina.                                            | RF        | Não          | 1.0    | [Brainstorm de elicitação de requisitos](https://youtu.be/OuCuQnkgDT4)         |
| B03           | O aplicativo deve permitir a visualização da disciplina.                                                              | RF        | Sim          | 1.0    | [Brainstorm de elicitação de requisitos](https://youtu.be/OuCuQnkgDT4)        |
| B04           | O aplicativo deve permitir a visualização das informações e trabalhos da disciplina (data, peso e tipo de avaliação). | RF        | Não          | 1.0    | [Brainstorm de elicitação de requisitos](https://youtu.be/OuCuQnkgDT4)        |
| B05           | O aplicativo deve permitir a visualização das notas das avaliações e trabalhos da disciplina.                         | RF        | Não          | 1.0    | [Brainstorm de elicitação de requisitos](https://youtu.be/OuCuQnkgDT4)         |
| B06           | O aplicativo deve permitir a visualização de certificados.                                                            | RF        | Não          | 1.0    | [Brainstorm de elicitação de requisitos](https://youtu.be/OuCuQnkgDT4)         |
