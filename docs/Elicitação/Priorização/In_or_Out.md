...
|          RQ24 | O usuário deve ser capaz de realizar as principais funções do aplicativo (cadastro, login, busca, e envio de dados) em até 8 minutos de uso, sem necessidade de treinamento prévio.                                                                                                            |    RNF    |     In      |  1.0   | [Entrevista 1](./Tecnicas/Entrevista.md), [Questionário](./Tecnicas/Questionário.md), [Brainstorming](./Tecnicas/Brainstorming.md) |
