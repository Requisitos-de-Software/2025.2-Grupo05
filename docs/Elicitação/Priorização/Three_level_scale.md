...
| RQ17         | O aplicativo deve permitir a visualização da disciplina e o professor que ministra.                                                                               | RF        | Não          | 1.0    | Alta                                                      |
| RQ18       | O aplicativo deve permitir a visualização do horário e sala da disciplina.                                                                                   | RF        | Não          | 1.0    | Alta                                                          |
| RQ19          | O aplicativo deve permitir a visualização das informações e trabalhos da disciplina (data, peso e tipo de avaliação).                                        | RF        | Não          | 1.0    | Alta              |
| RQ20          | O aplicativo deve permitir a visualização das notas das avaliações e trabalhos da disciplina.                                                                 | RF        | Não          | 1.0    | Alta              |                                        
| RQ21        | O aplicativo deve notificar avaliações com uma semana antes e dois dias de antecedência.                                                                   | RF        | Não          | 1.0    | Média              |
| RQ22        | O aplicativo deve notificar faltas após serem lançadas no aplicativo.    | RF        | Não          | 1.0    | Média                                                     |
| RQ23         | O aplicativo deve notificar informações sobre o benefício Pé-de-Meia (parcelas e valores).                                                                   | RF        | Não          | 1.0    | Alta           |
| RQ24          | O usuário deve ser capaz de realizar as principais funções do aplicativo (cadastro, login, busca, e envio de dados) em até 8 minutos de uso, sem necessidade de treinamento prévio.                                                                                                  | RNF       | Sim          | 1.0    | Alta              |
| RQ25         | O aplicativo deve ter uma linguagem simples adequada ao usuário.                                                                                             | RNF       | Sim          | 1.0    | Alta              |
| RQ26          | O aplicativo deve carregar suas informações em no máximo 3 segundos.                                                                                        | RNF       | Não          | 1.0    | Média              |
| RQ27          | O aplicativo deve possibilitar o usuário emitir a declaração de vínculo da instituição de ensino.                                                            | RF        | Não          | 1.0    | Alta              |
| RQ28          | O aplicativo deve possibilitar o usuário emitir seu histórico da instituição de ensino.                                                                  | RF        | Não          | 1.0    | Alta               |
| RQ29          | O aplicativo deve possibilitar o usuário visualizar o boletim da instituição de ensino.                                                                        | RF        | Não          | 1.0    | Média               |
| RQ30          | O aplicativo deve possibilitar o usuário visualizar programas estudantis (FIES, Prouni, etc.).                                                               | RF        | Sim          | 1.0    | Alta               |
| RQ31          | O aplicativo deve possibilitar o usuário visualizar parcelas pagas e que faltam do auxílio.                                                                  | RF        | Sim          | 1.0    | Média            |
| RQ32          | O aplicativo deve possibilitar o usuário visualizar o valor total do auxílio.                                                                                | RF        | Não          | 1.0    | Alta           |
| RQ33          | O aplicativo deve possibilitar o usuário visualizar a conta bancária cadastrada do auxílio.                                                                  | RF        | Não          | 1.0    | Alta           |
| RQ34          | O aplicativo deve possibilitar o usuário visualizar o dia do pagamento do auxílio.                                                                           | RF        | Não          | 1.0    | Alta           |
| RQ35          | O aplicativo deve possibilitar o usuário acessar um fórum de dúvidas sobre o auxílio.                                                                        | RF        | Não          | 1.0    | Alta            |
| RQ36          | O aplicativo deve possibilitar o usuário ser atendido em um canal de conversa sobre o auxílio.                                                               | RF        | Não          | 1.0    | Alta            |
| RQ37          | O aplicativo deve possibilitar o usuário visualizar datas de eventos e atividades escolares em um calendário.                                                | RF        | Não          | 1.0    | Alta            |
| RQ38          | O aplicativo deve ter informações unificadas sobre sua jornada escolar.                                                                                      | RF        | Sim          | 1.0    | Alta               |
| RQ39          | O aplicativo deve manter as informações do usuário seguras e privadas.                                                                                       | RR        | Sim          | 1.0    | Alta               |
| RQ40          | O aplicativo deve ser acessível (contraste em cores, suporte à Libras e auto-descrição).                                                                     | RNF       | Não          | 1.0    | Alta               |
| RQ41          | O aplicativo deve oferecer um ranqueamento de matérias por nota, para orientar o foco do estudante.                                                          | RF        | Não          | 1.0    | Média            |
| RQ42          | O aplicativo deve ter uma página de perfil com as informações do usuário (nome, instituição e ano/semestre).                                                 | RF        | Sim          | 1.0    | Alta            |
| RQ43          | O aplicativo deve possibilitar o usuário editar suas informações na página de perfil.                     | RF        | Sim          | 1.1    | Média                                                     |
| RQ44          | O aplicativo deve possibilirar o usuário conseguir editar suas informações bancárias pelo gov.               | RF        | Não          | 1.1    | Média                                                         |
| RQ45          | O aplicativo deve possuir uma agenda para organização pessoal do usuário através de atividades.                                                               | RF        | Não          | 1.0    | Média                                                       |
| RQ46          | A agenda deve possuir a opção do usuário inserir atividades.                                                                                                  | RF        | Não          | 1.0    | Alta                                                       |
| RQ47          | A agenda deve possuir a opção do usuário editar atividades.                                                                                                   | RF        | Não          | 1.0    | Média                                                       |
| RQ48          | A agenda deve possuir a opção do usuário excluir atividades.                                                                                                  | RF        | Não          | 1.0    | Média                                                       |
| RQ49          | A agenda deve notificar o usuário sobre atividades inseridas com um dia de antecedência.                                                                     | RF        | Não          | 1.0    | Alta                                                      |
| RQ50          | A agenda deve permitir o usuário inserir um horário e data na criação de uma atividade.                                                                      | RF        | Não          | 1.0    | Alta                                                       |
| RQ51          | A agenda deve permitir o usuário avaliar suas atividades com grau de importância.                                                                            | RF        | Não          | 1.0    | Alta                                                       |
| RQ52          | O aplicativo deve oferecer integração na agenda entre outros aplicativos de organização pessoal.                                                              | RF        | Não          | 1.0    | Alta                                                      |
| RQ53          | O aplicativo deve oferecer um tutorial em vídeo sobre suas funcionalidades.                                                                                  | RF        | Não          | 1.0    | Média                                                      |
| RQ54          | O aplicativo deve ter a possibilidade de encontrar qualquer funcionalidade desejada em até 45 segundos.                                                      | RNF       | Não          | 1.0    |      Média     |
| RQ55          | O aplicativo deve notificar quando editais de vestibulares forem abertos.                                                                                      | RF        | Não          | 1.0    |    Alta       |
| RQ56          | O aplicativo deve ter um fórum entre estudantes.                                                                                                            | RF        | Não          | 1.1    | Alta  |
| RQ57          | O aplicativo deve ter um fórum por disciplina entre estudantes e professores.                                                                                  | RF        | Não          | 1.0    |Média  |
| RQ58          | O aplicativo deve permitir a emissão de diplomas.                                                                                                            | RF        | Não          | 1.0    |   Alta     |
| RQ59          | O aplicativo deve ter um canal de suporte ao usuário.                                                                  | RF        | Sim          | 1.0    | Alta  |
| RQ60           | O aplicativo deve permitir a visualização de certificados.                                                             | RF        | Não          | 1.0    |     Alta      |
| RQ61          | O aplicativo deve permitir a visualização de ocorrências.                                                              | RF        | Não          | 1.0    |      Média     |
