...
| -------- | ------------ | -------------- | ---------- | -------------- | -------------- | ----------- |
| Rich Picture | 0 | 0 | 0 | 1 ([Rich picture](/docs/Pré-Rastriabilidade/Rich-picture.md)) | 0 | 1 ([Rich picture](/docs/Pré-Rastriabilidade/Rich-picture.md)) |
| Validação do RichPicture | 0 | 0 | 0 | 0 | 0 | 0 |
| Total de documentos criados | 1 ([Lista de verificação](/docs/Pré-Rastriabilidade/Rich_pictureLV.md)) | 2 ([Lista de verificação](/docs/Pré-Rastriabilidade/Rich_pictureLV.md) e [Rich picture](/docs/Pré-Rastriabilidade/Rich-picture.md)) | 1 ([Lista de verificação](/docs/Pré-Rastriabilidade/Rich_pictureLV.md)) | 1 ([Lista de verificação](/docs/Pré-Rastriabilidade/Rich_pictureLV.md)) | 1 ([Lista de verificação](/docs/Pré-Rastriabilidade/Rich_pictureLV.md)) | 1 ([Lista de verificação](/docs/Pré-Rastriabilidade/Rich_pictureLV.md)) |
| Total de documentos revisados | 1 | -------------- | 1 | -------------- | -------------- | ----------- |
