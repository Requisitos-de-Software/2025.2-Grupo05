...
<iframe width="560" height="315" src="https://www.youtube.com/embed/A5xM4hjlhRo?si=P2msPpxXHsQ5a77l" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
| ---- | ----------------------------------------------------------------------------------------------------------------------- | ----------- | 
| 1    | Os atores interagem com o sistema?                                                                                      | Não         | 
| 2    | Os atores possuem uma descrição clara?                                                                                  | Não         | 
| 3    | Os atores são representados como um boneco?                                                                             | Não         | 
| 4    | Os atores envolvidos nos processos e suas responsabilidades estão identificados?                                        | Não         | 
| 5    | As operações representam o que o sistema faz?                                                                           | Não         | 
| 6    | Cada operação é executada por um ator ou por outra operação?                                                            | Não         | 
| 7    | As operações são representadas como círculos com descrições dentro?                                                     | Não         | 
| 8    | Os armazenamentos de dados é correspondente às tabelas do banco de dados ou arquivos do sistema?                        | Não         | 
| 9    | Os armazenamos de dados são escritos ou lidos somente por operações?                                                    | Não         | 
| 10   | Os armazenamentos de dados foram representados graficamente como retângulos?                                            | Não         | 
| 11   | As setas indicam as direções das informações entre os atores, operações e armazenamento de dados?                       | Não         | 
...
A tabela 6 mostra a lista de verificação da tecnica de elicitação análise de documentos.
...
A tabela 7 mostra a lista de verificação da tecnica de elicitação questionário.
...
A tabela 8 mostra a lista de verificação da tecnica de elicitação brainstorm.
...
| 8 – Cada participante teve um tempo para compartilhar suas ideias?                                                         |     |     | Não                               | 1.0                              |
| 9 \- Os participantes foram informados no início da atividade sobre os objetivos e procedimentos que irão ocorrer?         |     |     | Não                               | 1.0                              |
| 10 \- O moderador repetiu a pergunta inicial ou as regras caso os participantes tenham se desviado dos objetivos?          |     |     | Não                               | 1.0                              |
...
A tabela 9 mostra a lista de verificação da tecnica de elicitação entrevista.
...
A tabela 10 mostra a lista de verificação da tecnica de priorização in or out.
...
A tabela 11 mostra a lista de verificação da tecnica de priorização moscow.
...
A tabela 12 mostra a lista de verificação da tecnica de priorização 100$.
...
A tabela 13 mostra a lista de verificação da tecnica de priorização three-level scale.
...
A tabela 14 mostra a lista de verificação da modelagem de requisitos.

| O github pages possui:                                                                                                                                                                                                                                         | Avaliação     | Versão, Data e hora da avaliação |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | :------------------------------: |
| 1 \- As especificações dos cenários para o projeto?                                                                                                                                                                                                            | Sim           |     Versão 1.0 - 11/11/2025      |
| 2 \-Os léxicos possuem os tipos verbo, objeto, estado?                                                                                                                                                                                                         | Sim           |     Versão 1.0 - 11/11/2025      |
| 3 \- Os léxicos possuem ligações entre si. (hiper links)?                                                                                                                                                                                                      | Não           |     Versão 1.0 - 11/11/2025      |
| 4 \- Sobre o Diagrama de caso de Uso, há uma legenda explicando os componentes do diagrama (notação)?                                                                                                                                                          | Sim           |     Versão 1.0 - 11/11/2025      |
| 5 \- No diagrama de Caso de Uso há ao menos um caso de uso com pontos de extensão?                                                                                                                                                                             | Sim           |     Versão 1.0 - 11/11/2025      |
| 6 \- A especificação do diagrama de caso de uso (com Nome, Descrição, Atores, Pré- Condição, Pós-Condição, Fluxo Principal, Fluxo Alternativo e Fluxo de Exceção etc.)? Todos os itens estão preenchidos?                                                      | Sim           |     Versão 1.0 - 11/11/2025      |
| 7 \- A gravação da participação do cliente e/ou persona na validação dos Léxicos?                                                                                                                                                                              | Sim           |     Versão 1.0 - 11/11/2025      |
| 8 \- A gravação da participação do cliente e/ou persona na validação dos Cenários?                                                                                                                                                                             | Sim           |     Versão 1.0 - 11/11/2025      |
| 9 \- A gravação da participação do cliente e/ou persona na validação do Diagrama de Caso de Uso e especificação do Caso de uso?                                                                                                                                | Sim           |     Versão 1.0 - 11/11/2025      |
| 10 \- A gravação da participação do cliente e/ou persona na validação do Especificação Suplementar?                                                                                                                                                            | Sim           |     Versão 1.0 - 11/11/2025      |
| 11 \- Cada cenário é rastreável (possui o requisito de origem e esse requisito possui uma origem em ao menos uma técnica de elicitação) (com hiperlink)?                                                                                                       | Sim           |     Versão 1.0 - 11/11/2025      |
| 12 \- Cada especificação de Caso de uso é rastreável (possui o requisito de origem e esse requisito possui uma origem em ao menos uma técnica de elicitação) (com hiperlink)?                                                                                  | Sim           |     Versão 1.0 - 11/11/2025      |
...
| 29 \- Possui um tópico de agradecimento informando o uso de Inteligência Artificial (IA) Generativa no documento da Especificação Suplementar1?                                                                                                                | Sim           |     Versão 1.0 - 11/11/2025      |

<figcaption align="center">Tabela 14: Lista de inspeção modelagem de requisitos: Cenários , Léxico, Use Case, Especificação Suplementar.</figcaption>

<font size="3"><p style="text-align: center">Fonte: André Barros Sales.</p></font>

## Lista de Inspeção - Cenários

A tabela 15 mostra a lista de verificação da técnica.

| O github pages possui:                                                                                        | Avaliação | Versão, Data e hora da avaliação |
| :------------------------------------------------------------------------------------------------------------ | --------- | :------------------------------: |
| 1 \- O cenário inclui um título que descreve brevemente a situação?                                           | Sim       |     Versão 1.0 - 11/11/2025      |
| 2 \- O cenário identifica os atores participantes?                                                            | Sim       |     Versão 1.0 - 11/11/2025      |
...
| 10 \-O cenário é rico em detalhes contextuais, evitando abstrações?                                           | Sim       |     Versão 1.0 - 11/11/2025      |

<figcaption align="center">Tabela 15: Lista de inspeção cenários.</figcaption>
...
A tabela 16 mostra a lista de verificação do léxico.
...
A tabela 17 mostra a lista de verificação da técnica.
...
A tabela 18 mostra a lista de verificação do caso de uso.

| O github pages possui:                                                                                                                                                                 | Avaliação     | Versão, Data e hora da avaliação |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | :------------------------------: |
| 1- O sistema é representado por um retângulo?                                                                                                                                          | Sim           |     Versão 1.0 - 11/11/2025      |
| 2- O sistema possui um nome?                                                                                                                                                           | Sim           |     Versão 1.0 - 11/11/2025      |
| 3- Tudo o que ocorre dentro da aplicação está dentro do retângulo?                                                                                                                     | Sim           |     Versão 1.0 - 11/11/2025      |
| 4- Os atores estão posicionados fora do sistema?                                                                                                                                       | Sim           |     Versão 1.0 - 11/11/2025      |
| 5- Os atores primários (iniciam a utilização do sistema) estão agrupados à esquerda do sistema?                                                                                        | Sim           |     Versão 1.0 - 11/11/2025      |
| 6- Os atores secundários (reagem as ações dos atores primários) estão agrupados à direita do sistema?                                                                                  | Sim           |     Versão 1.0 - 11/11/2025      |
| 7- Os casos de uso são representados por uma forma oval?                                                                                                                               | Sim           |     Versão 1.0 - 11/11/2025      |
| 8- Os casos de uso representam uma ação que realiza uma tarefa dentro do sistema?                                                                                                      | Sim           |     Versão 1.0 - 11/11/2025      |
| 9- As descrições em um caso de uso começam com um verbo?                                                                                                                               | Sim           |     Versão 1.0 - 11/11/2025      |
| 10- Cada ator interage com pelo menos um caso de uso do sistema?                                                                                                                       | Sim           |     Versão 1.0 - 11/11/2025      |
...
A tabela 19 mostra a lista de verificação da modelagem de requisitos ágil, baseada no documento fornecido pela disciplina.

| O github pages possui:                                                                                                                                             |   Avaliação   | Versão, Data e hora da avaliação |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------: | :------------------------------: |
| 1 - As Histórias de Usuário?                                                                                                                                       |      sim      |     Versão 1.0 - 11/11/2025      |
| 2 - O "quem", "o que" e o "por que" estão definidos na história de usuário?                                                                                        |      sim      |     Versão 1.0 - 11/11/2025      |
| 3 - A validação das histórias de usuário de modo presencial com o usuário?                                                                                         |      Não      |     Versão 1.0 - 11/11/2025      |
| 4 - A gravação da validação das histórias de usuário?                                                                                                              |      Sim      |     Versão 1.0 - 11/11/2025      |
| 5 - Critério de aceitação para cada história possui?                                                                                                               |      Sim      |     Versão 1.0 - 11/11/2025      |
| 6 - A validação dos critérios de aceitação das histórias de usuário de modo presencial com o usuário?                                                              |      Sim      |     Versão 1.0 - 11/11/2025      |
| 7 - A gravação da validação dos critérios de aceitação das histórias de usuário?                                                                                   |      Sim      |     Versão 1.0 - 11/11/2025      |
| 8 - A referência bibliográfica do modelo/estrutura da Histórias de Usuário?                                                                                        |      Sim      |     Versão 1.0 - 11/11/2025      |
| 9 - As Histórias de Usuário são rastreáveis a sua origem?                                                                                                          |      Sim      |     Versão 1.0 - 11/11/2025      |
| 10 - O cartão de especificação do RNF                                                                                                                              |      Sim      |     Versão 1.0 - 11/11/2025      |
| 11 - Os softgoals condizem com o contexto?                                                                                                                         |      Sim      |     Versão 1.0 - 11/11/2025      |
| 12 - Os impactos foram corretamente propagados?                                                                                                                    |      Não      |     Versão 1.0 - 11/11/2025      |
| 13 - Possui um tópico de agradecimento informando o uso de Inteligência Artificial (IA) Generativa no documento dos Léxicos¹?                                      | Sim |     Versão 1.0 - 11/11/2025      |
| 14 - Possui um tópico de agradecimento informando o uso de Inteligência Artificial (IA) Generativa no documento dos Cenários¹?                                     | Sim |     Versão 1.0 - 11/11/2025      |
| 15 - Possui um tópico de agradecimento informando o uso de Inteligência Artificial (IA) Generativa no documento da Especificação Suplementar¹?                     | Sim |     Versão 1.0 - 11/11/2025      |
| 16 - Itens de verificação do conteúdo da disciplina dessa etapa elaborados pela equipe com referência bibliográfica da fonte, foto do texto da referência e autor? |      Não      |     Versão 1.0 - 11/11/2025      |

<figcaption align="center">Tabela 19: Lista de inspeção da Modelagem de Requisitos - Ágil.</figcaption>
...
A tabela 20 mostra a lista de verificação para a técnica de História de Usuário.

| O github pages possui:                                                                   | Avaliação | Versão, Data e hora da avaliação |
| :--------------------------------------------------------------------------------------- | :-------: | :------------------------------: |
| 1 - A história segue a estrutura "Como um [ator], eu quero [ação] para que [resultado]"? |    Sim    |     Versão 1.0 - 11/11/2025      |
| 2 - Cada história de usuário é independente das outras ("Independent")?                  |    Sim    |     Versão 1.0 - 11/11/2025      |
| 3 - A história de usuário é negociável ("Negotiable")?                                   |    Sim    |     Versão 1.0 - 11/11/2025      |
| 4 - A história agrega valor para o usuário/cliente ("Valuable")?                         |    Sim    |     Versão 1.0 - 11/11/2025      |
| 5 - A complexidade da história pode ser estimada pela equipe ("Estimable")?              |    Sim    |     Versão 1.0 - 11/11/2025      |
| 6 - A história é pequena o suficiente para ser concluída em uma iteração ("Small")?      |    Sim    |     Versão 1.0 - 11/11/2025      |
| 7 - A história é testável e possui critérios de aceite claros ("Testable")?              |    Sim    |     Versão 1.0 - 11/11/2025      |

<figcaption align="center">Tabela 20: Lista de inspeção da técnica História de Usuário.</figcaption><br>
...
A tabela 21 mostra a lista de verificação para o artefato Backlog.

| O github pages possui:                                                                      | Avaliação | Versão, Data e hora da avaliação |
| :------------------------------------------------------------------------------------------ | :-------: | :------------------------------: |
| 1 - O backlog é uma lista ordenada de todos os itens desejados no produto?                  |    Sim    |     Versão 1.0 - 11/11/2025      |
| 2 - Os itens no topo do backlog são mais detalhados e de maior prioridade?                  |    Não    |     Versão 1.0 - 11/11/2025      |
| 3 - O backlog é um artefato vivo, constantemente atualizado?                                |    Sim    |     Versão 1.0 - 11/11/2025      |
| 4 - As especificações dos itens do product backlog foram baseados em histórias de usuários? |    Sim    |     Versão 1.0 - 11/11/2025      |
| 5 - O backlog está visível e transparente para todos os stakeholders?                       |    Sim    |     Versão 1.0 - 11/11/2025      |
| 6 - Os itens do product backlog tem critérios de aceitação?                                 |    Não    |     Versão 1.0 - 11/11/2025      |
| 7 - O Product Backlog foi uma lista de funcionalidades desejadas?                           |    Sim    |     Versão 1.0 - 11/11/2025      |

<figcaption align="center">Tabela 21: Lista de inspeção do artefato Backlog.</figcaption><br>
Autor: <a href="https://github.com/CamilaSilvaC">Camila Silva</a>, <a  href="https://github.com/GeovannaUmbelino"> Geovanna Alves </a>, <a href="https://github.com/mel14-hub">Lara Mota</a>, <a href="https://github.com/luisa12ll">Luisa de Souza</a>, <a href="https://github.com/pedrohpsantos">Pedro Henrique</a> e <a href="https://github.com/Yanmatheus0812">Yan Matheus</a>

## Lista de Verificação - NFR Framework

A tabela 22 mostra a lista de verificação para a técnica NFR Framework.

| O github pages possui:                                                                                                 | Avaliação | Versão, Data e hora da avaliação |
| :--------------------------------------------------------------------------------------------------------------------- | :-------: | :------------------------------: |
| 1 - O NFR Framework foi utilizado para representar e analisar requisitos não-funcionais?                               |    Sim    |     Versão 1.0 - 11/11/2025      |
| 2 - O NFR Framework utilizou o conceito de softgoal para expressar requisitos não-funcionais?                          |    Sim    |     Versão 1.0 - 11/11/2025      |
| 3 - O NFR Framework representou os requisitos não-funcionais através de um grafo SIG (Softgoal Interdependency Graph)? |    Não    |     Versão 1.0 - 11/11/2025      |
| 4 - O SIG contém decisões de projeto e justificativas associadas?                                                      |    Não    |     Versão 1.0 - 11/11/2025      |
| 5 - O NFR Framework classificou softgoals em três tipos distintos (NFR, Operacionalização e Afirmação)?                |    Sim    |     Versão 1.0 - 11/11/2025      |
| 6 - O procedimento de avaliação define o grau de satisfação de cada softgoal?                                          |    Não    |     Versão 1.0 - 11/11/2025      |
| 7 - Para representar os softgoals NFR foram usadas nuvens claras?                                                      |    Não    |     Versão 1.0 - 11/11/2025      |
| 8 - Os softgoals de Operacionalização foram usados para representar soluções de implementação para satisfazer RNFs?    |    Sim    |     Versão 1.0 - 11/11/2025      |
| 9 - Para representar os softgoals de Operacionalização foram usadas nuvens com linhas mais grossas?                    |    Não    |     Versão 1.0 - 11/11/2025      |
| 10 - Para representar os softgoals de Afirmação foram usadas nuvens com linhas tracejadas?                             |    Não    |     Versão 1.0 - 11/11/2025      |

<figcaption align="center">Tabela 22: Lista de inspeção da técnica NFR Framework.</figcaption>
...
A tabela 23 mostra a lista de verificação para a rastreabilidade de requisitos.
...
| Os requisitos foram claramente ligados às suas fontes e aos artefatos criados durante o ciclo de vida de desenvolvimento?      |    Não           |          Versão 1.0 \- 29/10/2025                                              |
| Todos os requisitos possuem referência clara à sua origem?                                                                     |      Não         |          Versão 1.0 \- 29/10/2025                                              |
| O meta-modelo de Toranzo utilizou uma meta-classe chamada Elemento como base estrutural?                                      |        Não       |          Versão 1.0 \- 29/10/2025                                              |
...
| Cada requisito está devidamente ligado aos artefatos de implementação correspondentes?                                         |      Não         |           Versão 1.0 \- 29/10/2025                                             |
| O elo de agregação representa a composição de elementos dentro do modelo?                                                     |       Sim        |          Versão 1.0 \- 29/10/2025                                              |

<figcaption align="center">Tabela 23: Lista de inspeção 6 — Rastreabilidade de Requisitos.</figcaption>
