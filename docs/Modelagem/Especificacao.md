...
| [RQ10](https://requisitos-de-software.github.io/2025.2-Grupo05/Elicita%C3%A7%C3%A3o/Requisitos-Elicitados/#:~:text=de%20documenta%C3%A7%C3%A3o%20(ADD010)-,RQ10,-O%20aplicativo%20deve) | Suportabilidade (S) | O aplicativo deve ter disponibilidade gratuita nos sistemas operacionais: Android e iOS. | O aplicativo deve estar disponível gratuitamente para download e utilização nos sistemas operacionais Android e iOS. Isso garante que usuários de ambas as principais plataformas móveis possam acessar o sistema sem custos adicionais. | A disponibilização gratuita do aplicativo tanto no Android quanto no iOS garante ampla acessibilidade e alcance do público-alvo, independentemente do dispositivo utilizado. Além disso, ao suportar as duas principais plataformas móveis, o sistema promove maior portabilidade e reduz barreiras de entrada para os usuários, atendendo a requisitos de distribuição e compatibilidade essenciais para o sucesso do produto. | Alta | Sim | [Yan Matheus](https://github.com/Yanmatheus0812) | 
...
| 1.3 | 16/11/2025 | Adicionado o RNF10 | [Yan Matheus](https://github.com/Yanmatheus0812)                                                                                                                   | [Lara Souza](https://github.com/mel14-hub) |
