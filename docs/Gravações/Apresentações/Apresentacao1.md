...
| 9 | Os armazenamos de dados são escritos ou lidos somente por operações? | Conforme | São escritos e lidos por operações | |  |
...
| 12 | As setas tem uma ponta única? | Conforme | Possui setas de ponta única | |  |
...
| 15 | É possível ver uma clara distinção entre o que está dentro e o que está fora? | Conforme | Claramente visível |  | |
| 16 | O limite de sistema possibilita o usuário ignorar tudo o que está fora de seu limite? | Conforme | É possível ignorar |  |  |
| 17 | O Rich Picture contém um enunciado central do problema? | Conforme | Possui enunciado |  |  |
...
| 20 | O Rich Picture conta uma história? | Conforme | Conta uma história | | |
...
| 25 | As preocupações dos envolvidos estão visíveis no rich picture? | Conforme | Estão visíveis | | |
