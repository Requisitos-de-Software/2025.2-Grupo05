...
| --- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| 1   | Elicitar os requisitos da técnica de elicitação: Brainstorming | [Camilla Silva](https://github.com/CamilaSilvaC), [Luísa de Souza](https://github.com/luisa12ll) e [Pedro Henrique](https://github.com/Yanmatheus0812) | 25/09/2025 |
...
| ------ | ---------- | ------------------- | ---------------------------------------------- | -------------------------------------------------- |
| 1.0    | 03/10/2025 | Documentação da ata | [Luísa de Souza](https://github.com/luisa12ll) | [Pedro Henrique](https://github.com/pedrohpsantos) |
